...
class PortfolioSeeder extends Seeder
{
    public function run()
    {
        $projects = [
            ...
            [
                'title' => 'MYSUZUKI (Full-Stack Development)',
                'slug' => 'mysuzuki',
                'type' => 'Full-Stack Development',
                'category' => 'professional',
                'thumbnail' => '/images/projects/mysuzuki.jpg', // Placeholder
            ...
            [
                'title' => 'GES PROPERTY (Web Application)',
                'slug' => 'ges-property',
                'type' => 'Web Application',
                'category' => 'professional',
                'thumbnail' => '/images/projects/ges-property.jpg', // Placeholder
            ...
            [
                ...
                'slug' => 'hermes-agent-automated-daily-tasks',
                'type' => 'Automation & DevOps',
                'category' => 'personal',
                'thumbnail' => '/images/projects/hermes-agent.jpg', // Placeholder
            ...
            [
                'title' => 'MEPAY FORKOM (PPOB Services)',
                'slug' => 'mepay-forkom',
                'type' => 'PPOB Services',
                'category' => 'professional',
                'thumbnail' => '/images/projects/mepay-forkom.jpg', // Placeholder
            ...
            [
                'title' => 'ZAKU AI CHATBOT: Advanced Conversational AI',
                'slug' => 'zaku-ai-chatbot',
                'type' => 'AI/ML Development',
                'category' => 'personal',
                'thumbnail' => '/images/projects/zaku-ai-chatbot.jpg', // Placeholder
            ...
            [
                'title' => 'WEDDING INVITATION WEBSITE (Dynamic Personalized)',
                'slug' => 'wedding-invitation-website',
                'type' => 'Frontend Development',
                'category' => 'personal',
                'thumbnail' => '/images/projects/wedding-invitation.jpg', // Placeholder
            ...
            [
                'title' => 'LANDING PAGE SHOWCASE (Conversion-Optimized)',
                'slug' => 'landing-page-showcase',
                'type' => 'Frontend Development',
                'category' => 'personal',
                'thumbnail' => '/images/projects/landing-page-showcase.jpg', // Placeholder
